...
#include "stanExports_mvmr_horse.h"

RCPP_MODULE(stan_fit4mvmr_horse_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mvmr_horse")
